...
import { getTrustedPlaces } from "../services/trustedPlacesService.js";
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/safenavigation">
              <Button
                variant="outline"
                size="sm"
                className="rounded-2xl border-emerald-300 text-emerald-700 font-extrabold text-xs sm:text-sm px-4 py-2 hover:bg-emerald-50 flex items-center gap-1.5"
              >
        ...
        <CardContent className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-1">
            <div className="text-3xl font-black text-slate-900">
              {trustedPlacesCount} <span className="text-base font-bold text-slate-500">saved place{trustedPlacesCount === 1 ? "" : "s"}</span>
            </div>
            <p className="text-xs font-semibold text-slate-600">
              Quick-access safety anchors for guarded navigation & automatic emergency location context.
            </p>
          </div>

          <Link to="/safenavigation">
            <Button className="btn-premium btn-primary rounded-2xl px-5 py-2.5 text-xs font-extrabold shadow-md shrink-0">
              View on Safe Navigation
            </Button>
          </Link>
        </CardContent>
      </Card>
